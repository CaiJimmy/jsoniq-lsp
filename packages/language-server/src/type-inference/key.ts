...
export function buildInferenceKey(kind: string, position: { line: number; character: number }, ...names: string[]): InferenceKey {
...
export function buildInferenceKeyForDefinition(definition: SourceDefinition): InferenceKey {
    switch (definition.kind) {
        case "function":
            return buildInferenceKey("function", definition.range.start, functionNameWithoutArity(definition.name));
        case "parameter":
